...
# ===========================================================================
#
# $URL: svn+ssh://svn.oss-1701.com/vostok/trunk/vpm/test/tests/001-upgrade.py $
...
class TestUpgrade(unittest.TestCase):
    '''
    Standard case package upgrade
    A is version 0.0.1, B is version 0.0.2
    
    Expected outcome: Package A upgraded to Package B
    '''
    ...
    def setUp(self):
        ...
        ctrl_d1.settings['Version'] = '0.0.1'
        ctrl_d1.settings['Provides'] = 'Software'
        ...
        ctrl_d1.settings['Version'] = '0.0.2'
        ctrl_d2.settings['Provides'] = 'Software'
