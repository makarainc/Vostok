...
# ===========================================================================
#
# $URL: svn+ssh://svn.oss-1701.com/vostok/trunk/vpm/test/tests/006-install-depend2.py $
...
class TestDependError(unittest.TestCase):
    '''
    Error case 1: dependee installed before provider
    
    Expected outcome: both packages installed, dependee not configured    
    '''
