...
# ===========================================================================
#
# $URL: svn+ssh://svn.oss-1701.com/vostok/trunk/vpm/test/tests/007-install-depend3.py $
...
class TestDependChain(unittest.TestCase):
    '''
    Standard case 2: dependency chain
    
    Expected outcome: all packages installed and configured    
    '''
    ...
    def testDependChain(self):
        ...
        self.assertEqual(VPM.DB.INSTALLED, self.p.db().status(self.test3))
