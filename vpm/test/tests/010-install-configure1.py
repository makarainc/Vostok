...
# ===========================================================================
#
# $URL: svn+ssh://svn.oss-1701.com/vostok/trunk/vpm/test/tests/010-install-configure1.py $
...
class TestInstallConfigure(unittest.TestCase):
    '''
    Standard case package configuration case
    B configures settings for A
    
    Expected outcome: Both packages installed and configured
    '''
